...
def find_breaking_point(floors):
    """
    Finds breaking point by increasing egg1 at decreasing intervals and egg2 at steady interval.
    """
...
print("breaking point = " + str(find_breaking_point(100)))
print("drops = " + str(count_drops))
